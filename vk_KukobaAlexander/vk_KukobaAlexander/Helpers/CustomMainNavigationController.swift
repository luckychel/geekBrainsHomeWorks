...
class CustomMainInteractiveTransition: UIPercentDrivenInteractiveTransition {
    var hasStarted = false
    var shouldFinish = false
}

class CustomMainNavigationController: UINavigationController, UINavigationControllerDelegate {

    let interactiveTransition = CustomMainInteractiveTransition()
    ...
    func navigationController(_ navigationController: UINavigationController, animationControllerFor operation: UINavigationController.Operation,
        ...
        switch operation {
        case .push:
            return PushMainAnimator()
        case .pop:
            return PopMainAnimator()
        case .none:
            return nil
        @unknown default:
            return nil
